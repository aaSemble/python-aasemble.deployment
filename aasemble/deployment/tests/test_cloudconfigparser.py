...
class CloudConfigParserTestCase(unittest.TestCase):
    def test_load_cloud_config(self):
        ...
        self.assertEquals(driver_class, GCEDriver)
        self.assertEquals(driver_kwargs, {'gce_key_file': '/path/to/key.json',
                                          'location': 'location1'})
        self.assertEquals(mappings, {'images': {'trusty': 'ubuntu1404'},
